...
## Akaike Information Criterion for Regression
...
## Akaike Information Criterion for Likelihood
...
2.  Split the observations into folds $k=1, \ldots, K$ of (roughly) equal size $n_{k} \simeq n / K$. Let $I_{k}$ denote the observations in fold $k$
...
## Many Selection Criteria are Similar
...
## Relation with Likelihood Ratio Testing
...
![](images//2022_10_23_101d59f261a704807a3bg-17.jpg)


1.  The observations $\left(Y_{i}, X_{\boldsymbol{i}}\right), i=1, \ldots, n$, are independent and identically distributed.

2.  $\mathbb{E}[e \mid X]=0$.

3.  $\mathbb{E}\left[e^{2} \mid X\right]=\sigma^{2}$.

4.  $\mathbb{E}\left[|e|^{4 r} \mid X\right] \leq B<\infty$ for some $r>1$.
...
1.  Start with all regressors $\left\{X_{1}, \ldots, X_{K}\right\}$ included in the "active set".
...
1.  Start with the null set $\{\varnothing\}$ as the "active set" and all regressors $\left\{X_{1}, \ldots, X_{K}\right\}$ as the "inactive set".

2.  For $m=1, \ldots, \min (n-1, K)$
...
## The MSE of Model Selection Estimators
...
![](images//2022_10_23_101d59f261a704807a3bg-23.jpg)

(a) MSE, $K=1$

![](images//2022_10_23_101d59f261a704807a3bg-23(1).jpg)
...
![](images//2022_10_23_101d59f261a704807a3bg-24.jpg)
...
1.  wmse $[\widetilde{\theta}]<$ wmse $[\hat{\theta}]$ if $0<w<2 K /(K+\lambda)$.

2.  wmse $[\widetilde{\theta}]$ is minimized by the shrinkage weight $w_{0}=K /(K+\lambda)$.

3.  The minimized WMSE is wmse $[\widetilde{\theta}]=K \lambda /(K+\lambda)$.
...
1.  If $0<c<2(K-2)$ then wmse $[\widetilde{\theta}]<$ wmse $[\widehat{\theta}]$.
...
## Interpretation of the Stein Effect
...
![](images//2022_10_23_101d59f261a704807a3bg-30.jpg)
...
2.  Shrink the regression coefficients towards a set of restrictions.

3.  Shrink a set of estimates (or coefficients) towards their common mean.

4.  Shrink a set of estimates (or coefficients) towards a parametric model.

5.  Shrink a nonparametric series model towards a parametric model.
...
![](images//2022_10_23_101d59f261a704807a3bg-33.jpg)

(a) Experience Profile

![](images//2022_10_23_101d59f261a704807a3bg-33(1).jpg)
...
![](images//2022_10_23_101d59f261a704807a3bg-35.jpg)

(a) Least Squares Estimates

![](images//2022_10_23_101d59f261a704807a3bg-35(1).jpg)
...
![](images//2022_10_23_101d59f261a704807a3bg-36.jpg)
...
![](images//2022_10_23_101d59f261a704807a3bg-41.jpg)
